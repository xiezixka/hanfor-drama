<template>
  <div class="page">
    ...
    <div v-else class="grid">
      ...
      >
        ...
        <div class="card-body">
          ...
          <div class="project-meta">
            <span v-if="d.style" class="style-tag">{{ getVisualStyleLabel(d.style) }}</span>
      ...
      <!-- Empty State -->
      <button v-if="!dramas.length" type="button" class="card empty-card" @click="showCreate = true">
        ...
        <p class="empty-title">还没有短剧项目</p>
        <p class="empty-desc">点击这里新建第一个短剧项目</p>
      </button>
    </div>
...
import { getVisualStyleLabel, visualStyleOptions } from '~/utils/visualStyles'
